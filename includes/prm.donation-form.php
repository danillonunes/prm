...
add_action('plugins_loaded', 'prm_subscription_paypal_notification');
...
function prm_subscription_paypal_notification() {
	if (isset($_GET['prm_subscription_return']) && $_GET['prm_subscription_return'] == 'paypal' && isset($_GET['prm_subscription_patron_id'])) {
		...
		if ($verification['body'] == 'VERIFIED') {
			...
			prm_donation_form_payment_complete($_GET['prm_subscription_patron_id']);
		}
	}
}
